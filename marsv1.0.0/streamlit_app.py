            ...
            with explainer:
                if Add_btn:
                    ...
                    def split_and_duplicate(row):
                        ...
                        tutor_emplids = str(row['TUTOR EMPLID']).split('&') if '&' in str(row['TUTOR EMPLID']) elif ', ' in str(row['TUTOR EMPLID']) str(row['TUTOR EMPLID']).split(', ') else str(row['TUTOR EMPLID']).split(',')
