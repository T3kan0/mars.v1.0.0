...
with z:
    st.markdown("<img src = 'https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/reg.png'>",unsafe_allow_html=True)
    #st.image('https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/reg.png', width=250)
with astep:
...
with col1:
    st.image('https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/logo3.png')
with col2:
...
st.sidebar.image('https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/logio.jpeg')
...
if bulk_files is not None:
    ...
    if len(n_files) == 1:
        ...
        with col4:
            ...
            st.image('https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/tech.png', width=130)  
    elif len(n_files) >=2:
        ...
        with col4:
            st.write(':blue[Type : ]',uploaded_file.type)
            st.image('https://github.com/T3kan0/mars.v1.0.0/tree/main/marsv1.0.0/static/tech.png', width=120)
        with col5:
            st.write(':blue[Register ]',j+1)
                ...
                new_name = st.multiselect(
                    ':blue[Select New Column Name: ⚙️]',
                     ['SUBJECT', 'CATALOG NBR', 'STUDENT EMPLID',
                      'TUTOR EMPLID', 'TYPE', 'DATE', 'START TIME','END TIME', 'STUDENT NAME', 'STUDENT SURNAME', 'STUDENT NAMES'])
                if Rename:
                    progress_bar = st.progress(0)
                    for perc_completed in range(100):
                        time.sleep(0.005)
