...
z, astep, logo = st.columns([0.20, 0.70, 0.10])
with z:
...
with astep:
    st.markdown("<h3 style='text-align: left; color: darkred;'>Academic Student Tutorial Excellence Programme</h3>", unsafe_allow_html=True)
